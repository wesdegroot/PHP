...
Amsterdam Van der Madeweg (VMW)

Amsterdam Zuid (ASDZ)

Anna Paulowna (ANA)

Antwerpen-Berchem (BERCH)

Antwerpen-Centraal (ATW)

Antwerpen-Luchtbal (ATWLB)

Antwerpen-Noorderdokken (ANDD)
...
Berlin Hbf (tief) (BERHBT)

Berlin Ostbahnhof (BHF)

Berlin Südkreuz (BPAF)

Berlin-Schönefeld Flug. (BERFL)
...
Bielefeld Hbf (BIELEF)

Bilthoven (BHV)

Bilzen (FIE)

Bischofshofen (BISCHO)
...
Brussel Nat. Luchthaven (FBNL)

Brussel-Centraal (BRUSC)

Brussel-Noord (BRUSN)

Brussel-Zuid/Midi (BRUSZ)
...
Dortmund Kirchderne (EDKD)

Dresden Hbf (DRESD)

Dresden-Neustadt (DRESDN)
...
Eschweiler Talbahnhof (ESCHT)

Eschweiler-Nothberg (ESCHN)

Eschweiler-Weisweiler (EWEIS)

Eschweiler-West (ESCHW)
...
Frankfurt (M) Hbf (FFFM)

Frankfurt (Oder) (FRANKO)

Frankfurt Flughafen Fernb (FNAF)

Freiburg (Breisgau) Hbf (RF)
...
Livorno Centrale (LIVOR)

Liège-Guillemins (LUIK)

Liège-Jonfosse (LUIKJ)

Liège-Palais (LUIKP)

Lochem (LC)

London St. Pancras (LONDS)
...
Marne-la-Vallée-Chessy (MARNE)

Marseille-St-Charles (MARS)

Martenshoek (MTH)

Mechelen (MECH)

Mechelen-Nekkerspoel (LNK)
...
Mortsel-Deurnesteenweg (GMD)

Mortsel-Oude God (GMOG)

Moutiers-Salins-Brides (MOUT)

Mönchengladbach Hbf (MCGB)

München Hbf (MUNCHH)

Münster (Westf.) Hbf (MUNST)

Münster Zentrum Nord (ENHF)
...
St. Johann im Pongau (STJOHP)

St. Johann in Tirol (STJOH)
...
Steinfurt Grottenkamp (EGRK)

Steinfurt-Borghorst (EBGO)

Steinfurt-Burgsteinfurt (EBFT)

Stendal (LS)

Stolberg Altstadt (STOLA)

Stolberg GBF (STOLGB)

Stolberg Hbf (STOLB)

Stolberg Mühlener Bahnhof (STOLMB)

Stolberg Rathaus (STOLR)

Stolberg Schneidemuhle (STOLSM)
...
Warszawa Centralna (WARSZC)

Warszawa Wschodnia (WARSAW)
...
Wuppertal Barmen (KWBA)

Wuppertal Hbf (WUPPH)

Wuppertal Oberbarmen (KWO)

Wuppertal-Vohwinkel (WUPPV)
...
file_put_contents("Train_Public_transport_NL.php", "<?php\r\n\r\n\$TrainStationsNL = " . var_export($newArray, true) . ";\r\n\r\n?>");
?>